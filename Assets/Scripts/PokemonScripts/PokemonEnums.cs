...
{ 
    ...
    VictoryRoadCaveDown,
    VictoryRoadCaveLeft,
    VictoryRoadCaveRight,
    VictoryRoadForestUp,
    VictoryRoadForestDown,
    VictoryRoadForestLeft,
    VictoryRoadForestRight,
    VictoryRoadIceCaveUp,
    VictoryRoadIceCaveDown,
    VictoryRoadIceCaveLeft,
    VictoryRoadIceCaveRight,
    VictoryRoadWaterCaveUp,
    VictoryRoadWaterCaveDown,
    VictoryRoadWaterCaveLeft,
    VictoryRoadWaterCaveRight,
    VictoryRoadRouteBuildingUp,
    VictoryRoadRouteBuildingDown,
    VictoryRoadRouteBuildingLeft,
    VictoryRoadRouteBuildingRight,
    SpecialExit,
    SpecialCaveUp,
    SpecialCaveDown,
    SpecialCaveLeft,
